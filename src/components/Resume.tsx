          ...
          <div className="flex flex-col items-center space-y-6">
            <div className="text-center">
              <h3 className="text-2xl font-semibold text-gray-900 dark:text-white mb-2">
                Java Full Stack Developer | End-to-End Web Solutions Expert
              </h3>
              <p className="text-gray-600 dark:text-gray-300">
                Experienced in building modern web apps using React.js, Java, Spring Boot
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4 w-full text-left">
              <div>
                ...
                <ul className="mt-2 space-y-1 text-gray-600 dark:text-gray-300">
                  <li>• Integrated frontend and backend via Axios and JSON APIs </li>
              ...
              <div>
                ...
                <ul className="mt-2 space-y-1 text-gray-600 dark:text-gray-300">
                  <li>• Designed responsive user interfaces using React.js and Bootstrap</li>
                </ul>
              </div>
            </div>
